<div id="<?php print $params['id']; ?>" class="osmplayer-<?php print $params['template']; ?> player-ui" style="width=<?php print filter_xss($params['width']); ?>; height=<?php print filter_xss($params['height']); ?>;">
